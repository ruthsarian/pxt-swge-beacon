...
//%
void activateGenericBeacon(uint16_t manufacturerId, BufferData *beaconData)
{
    ManagedBuffer beaconDataBuffer(beaconData);
    getBeaconService()->activateGenericBeacon(manufacturerId, beaconDataBuffer);
}
}
